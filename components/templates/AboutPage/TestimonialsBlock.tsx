...
const testimonials = [
    ...
    },
    {
        ...
        rating: 4.7,
        text: 'Обратилась в компанию АзиаМоторс, чтобы приобрести автомобиль из Китая, и осталась очень довольна. Мне привезли Exeed TX L 2021 года, машина в отличном состоянии, даже лучше, чем на фотографиях...',
        author: 'Елена Т.',
