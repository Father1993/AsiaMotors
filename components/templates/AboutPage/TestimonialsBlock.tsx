...
const testimonials = [
    {
        ...
        rating: 4.8,
        text: 'Грузовик пришел в идеальном состоянии, все документы на месте, доставка была организована вовремя Особенно хочу отметить персональное внимание к нашим запросам. Менеджер всегда были на связи, отвечал на все вопросы, а также предложили выгодные условия по скидкам для корпоративных клиентов. Ребята из китая всегда присылают выгодные спец. предложения по автомобилям. В следующий раз точно будем обращаться в Азиа Моторс для покупки техники для себя и компании. Рекомендую всем!',
        author: 'Perevozka27.ru',
        link: 'https://www.dvhab.ru/asiamotors#comments',
    },
    {
        platform: 'Яндекс',
    ...
    },
    {
        ...
        author: 'Дмитрий Р.',
        link: 'https://2gis.ru/khabarovsk/inside/4926447747620714/firm/70000001075238436/tab/reviews',
    },
]
