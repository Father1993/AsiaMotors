...
const testimonials = [
    {
        ...
        rating: 4.8,
        text: 'Хочу поделиться опытом заказа машины через Asia Motors. Долго присматривался к RAV-4, но цены в России кусались конкретно. Нашел ребят, списался с менеджером Михаилом- всё четко объяснил, показал реальные фотки и видео машин...',
        author: 'Дмитрий Р',
