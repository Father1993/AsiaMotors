...
export const metadata: Metadata = {
    ...
    description:
        'Asia Motors предоставляет услуги по поставке новых и подержанных автомобилей из Китая, включая доставку, таможенное оформление и страхование. Узнайте о лучших предложениях и гарантированной надежности автомобилей по доступным ценам',
    keywords:
