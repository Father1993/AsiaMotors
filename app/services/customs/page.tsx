...
export const metadata: Metadata = {
    ...
    description:
        'Профессиональное таможенное оформление автомобилей из Китая. Мы гарантируем быструю и безопасную растаможку авто, помощь в оформлении всех необходимых документов и выгодные условия для клиентов.',
    keywords:
